...
sobel_horizontal = sistema.makecorelation("Images/Shapes.png",
                                          "masks/sobel_horizontal.txt")
sobel_vertical = sistema.makecorelation("Images/Shapes.png",
...
sistema.plot_graficos_de_barras(sistema.build_histogram(sobel_horizontal))
